...
func SetupRoutes(app *fiber.App) {
	...
	paperTrading.Post("/start", startStrategyPaperTrading)     // Start strategy paper trading
	paperTrading.Post("/stop", stopStrategyPaperTrading)       // Stop strategy paper trading
	...
	app.Get("/strategy-dashboard", func(c *fiber.Ctx) error {
		return c.SendFile("../public/strategy_dashboard.html")
	})
